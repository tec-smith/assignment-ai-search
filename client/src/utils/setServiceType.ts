...
export const setServiceType = (value: { serviceType: string }): ServiceInputResponse => {
  ...
  switch (serviceType) {
    case 'Hotels':
      return { example: 'Try; Stockholm from 18th to 28th of March.' };
    case 'Flights':
      return { example: 'Try; Stockholm to Copenhagen from 10th to 20th of April.' };
    case 'Trains':
      return { example: 'Try; Stockholm to Uppsala from 7th to 17th of May.' };
    case 'Cars':
      return { example: 'Try; Stockholm from 1st to 11th of June.' };
    default:
